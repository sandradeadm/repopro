...
// Get user list from backend and populate main table
// Apply pagination, search and show each user's status
async function cargarUsuarios() {
    ...
    // Show user range and total in pagination
...
async function cargarUsuariosPorRol() {
    ...
    // Color palette for badges, can add more if there are more roles
    const colores = [
...
// Search button and pagination for main user table
